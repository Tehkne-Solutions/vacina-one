...
export default function Hero() {
  return (
    <section className="relative w-full h-[1050px] bg-white overflow-hidden font-franie">
      {/* Container de projecao: mantém coordenadas do Figma em qualquer resolucao */}
      <div className="absolute left-1/2 top-0 w-[1920px] h-full -translate-x-1/2">

        {/* MOSAICO */}
        <div className="absolute left-0 top-0 w-full h-full pointer-events-none">

          {/* 1. Menino — quadrada maior, z-20 */}
          <div className="absolute left-[164px] top-[80px] w-[340px] h-[340px] z-20">
            <Image
          ...
          <div className="absolute left-[524px] top-[130px] w-[362px] h-[544px] z-30">
            <Image
          ...
          <div className="absolute left-[245px] top-[440px] w-[260px] h-[260px] z-10">
            <Image
        ...
        {/* CONTEUDO TEXTUAL */}
        <div className="absolute left-[984px] top-[130px] w-[766px] flex flex-col gap-[30px]">
          <h1 className="text-[80px] font-black leading-[90px] tracking-tight text-vacina-dark">
            <span className="text-vacina-teal">Prote&#231;&#227;o</span> e{' '}
            <span className="text-vacina-teal">cuidado</span><br />
            para todas as fases<br />
            da vida
          </h1>
          ...
          <button className="w-[339px] h-[63px] bg-vacina-gold rounded-[50px] text-white text-[22px] font-black flex items-center justify-center hover:brightness-105 transition-all">
            Agendar Vacina&#231;&#227;o
          </button>
        </div>

        {/* Divisor */}
        <div className="absolute left-[163px] top-[800px] w-[1595px] h-[2px] bg-vacina-border" />

        {/* Carrossel */}
        <div className="absolute left-[163px] top-[870px] w-[1595px]">
          <LaboratoryCarousel />
        </div>
      </div>
    </section>
